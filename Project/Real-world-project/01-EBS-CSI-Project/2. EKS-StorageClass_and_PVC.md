...
kubectl apply -f manifest-file/01-storageCLass.yaml

# Create persistent volume claim
kubectl apply -f manifest-file/02-pvc.yaml
...
```sh
# Create configmap to attach as volume to DB
kubectl apply -f manifest-file/03-UserManagement-ConfigMap.yml

# Create secret for db password
kubectl apply -f manifest-file/04-mysql-secret.yaml

# Create deployment for mysql db
kubectl apply -f manifest-file/05-mysql-deployment.yaml

# Create service for mysql db
kubectl apply -f manifest-file/07-mysql-clusterIP-service.yaml
